...
fetch("/minecraft-bedock-edition-mods/versions.json", {
	cache: "reload"
	...
	img.src = `/minecraft-bedock-edition-mods/${e[0]}/pack_icon.png`;
	ele.append(img);
	ele.append(document.createElement("br"));
	const aEle = document.createElement("a");
	aEle.href = `/minecraft-bedock-edition-mods/mcpacks/${e[0]}.mcpack`;
