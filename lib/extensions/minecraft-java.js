...
fetch("/minecraft-java-edition-mods/versions.json", {
	cache: "reload"
	...
	img.src = `/minecraft-java-edition-mods/${e[0]}/src/main/resources/assets/${e[0]}/icon.png`;
	ele.append(img);
	ele.append(document.createElement("br"));
	const descEle = document.createElement("a");
	descEle.href = `/minecraft-java-edition-mods/${e[0]}`;
	...
	rev.forEach((version, i) => {
		...
		aEle.href = `/minecraft-java-edition-mods/${e[0]}/jars/${version}.jar`;
